...
def build_system_prompt(
    ...
    return (
        ...
        # f"- FIRST MESSAGE: 'Hello! 😊 Thank you for reaching out to KP Kids Studio. My name is Julie, and I am here to help. How can I assist you today?'\n"
            ...
            f"- CRITICAL: If packages have already been presented AND client asks 'how to book' or 'how do I proceed' — this means they want to book. Send booking fee instructions immediately. NEVER restart discovery.\n"
