...
def build_system_prompt(
    ...
    return (
        ...
        f"- FIRST MESSAGE ONLY (use ONLY when journey is 'entry' and there are NO previous messages): 'Hello! 😊 Welcome to KP Kids Studio. My name is Julie, and I am here to help. How can I assist you today?'\n"
