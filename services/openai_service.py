...
def build_system_prompt(
    ...
    return (
        ...
        f"- FIRST MESSAGE: 'Hello! Welcome to KP Kids Studio. What is your name and how can I assist you today?'\n"
        ...
        f"- Calculate prices strictly: base + extras = final price. Cake+video together = 50k not 59k.\n"
        f"- NEVER present more or fewer than 3 options after discovery.\n"
