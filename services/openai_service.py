...
def build_system_prompt(
    ...
    return (
        ...
        f"- On FIRST message: introduce studio warmly, offer your help\n"
        f"- Ask for client's name -  \n"
        f"- NEVER dump a price list immediately — ask 1-2 discovery questions first.\n"
        f"- Ask for child's name or children names\n"
        f"- Always ask ONE question at a time, never a form.\n"
        f"- After discovery: present EXACTLY 2 package options — never more, never one.\n"
