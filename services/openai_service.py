...
def build_system_prompt(
    ...
    return (
        ...
        f"  Details line 1(When client chooses a package: send payment details and end with: Just let me know once you are done!)\n"
        f"  Details line 2(When client confirms payment: reply ONLY with: Thank you! Give me 1 second to verify your payment. Then STOP.)\n"
