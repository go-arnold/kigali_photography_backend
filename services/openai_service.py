...
def build_system_prompt(
    ...
    return (
        ...
        f"- Guide: discovery → 3 options → booking fee(20k -deducted from package price, send payment details and end with: Just let me know once you are done!)  → prep (When client confirms payment: reply ONLY with: Thank you! Give me 1 second to verify your payment. Then STOP) → form → delivery → feedback.\n\n"
        f"ABSOLUTE RULES:\n"
