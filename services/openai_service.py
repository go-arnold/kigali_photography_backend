...
def build_system_prompt(
    ...
    if flow_mode == "question":
        ...
        return (
            ...
            f"  RW: 'Murakoze! ntago dufite igiciro cyihariye cy\\'ifoto imwe, ahubwo  Ibiciro dutanga biterwa n'ibiri muri package mwahisemo. 📦'"
