...
def build_system_prompt(
    ...
    return (
       ...
       # f"- FIRST MESSAGE: 'Hello! 😊 Thank you for reaching out to KP Kids Studio. My name is Julie, and I am here to help. How can I assist you today?'\n"
        ...
        f"  If client has ALREADY been told 'pricing depends on options' AND asks for prices AGAIN\n"
        ...
        f"  → Skip ALL remaining extras. Present 3 base packages immediately.\n"
