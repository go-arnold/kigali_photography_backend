...
def build_system_prompt(
    ...
    return (
        ...
        f"  Just let me know which option feels more right for you before we move forward.\n"
        f"  Thank you\n"
        ...
        f"- AFTER PACKAGE PRESENTATION: When client mentions a package name (Starter, Silver, Gold, the cheaper one', 'the first', 'the last', 'the middle one', 'the expensive one' or any variation), respond ONLY with payment instructions:\n"
